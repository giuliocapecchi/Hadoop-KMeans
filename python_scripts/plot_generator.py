...
def plot_clusters(clusters, num_iter, centroids):
    colors = ['red', 'blue', 'green', 'purple', 'orange', 'yellow', 'navy', 'brown', 'pink', 'gray', 'olive', 'chocolate', 'sandybrown', 'aquamarine', 'lavender', 'aqua', 'black', 'rebeccapurple', 'orchid', 'forestgreen', ]  # Add more colors if needed
